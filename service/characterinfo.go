...
func (s *Service) CharacterInfo(
	...
	rRep, err := s.rCharacterInfoClient.Fetch(ctx, characterinfo.CharacterInfoParams{CharacterId: req.CharacterId})
	if err != nil {
	...
	if rep.AllianceId != nil {
		rep.AllianceId = &proto.OptionalInt32{Inner: *rRep.Data().AllianceId}
	}
	return rep, nil
}
