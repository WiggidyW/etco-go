...
import (
	...
	systemsget "github.com/WiggidyW/eve-trading-co-go/client/configure/buybacksystems/get"
...
func (mbsc PbMergeBuybackSystemsClient) fetchMergeData(
	...
	chnBundleKeys := util.NewChanResult[map[string]struct{}](ctx)
	chnSendBundleKeys, chnRecvBundleKeys := chnBundleKeys.Split()
...
func (mbsc PbMergeBuybackSystemsClient) fetchBBuilderBundleKeys(
	ctx context.Context,
	chnSendBundleKeys util.ChanSendResult[map[string]struct{}],
) error {
