...
import (
	...
	builderget "github.com/WiggidyW/etco-go/client/configure/btypemapsbuilder/get"
	fkbucketwriter "github.com/WiggidyW/etco-go/client/configure/internal/fixedkeybucket/writer"
	marketsget "github.com/WiggidyW/etco-go/client/configure/markets/get"
...
func (mbbc PbMergeBuybackSystemTypeMapsBuilderClient) Fetch(
	...
	chnBuilderSend, chnBuilderRecv := chanresult.
		NewChanResult[cfg.BuybackSystemTypeMapsBuilder](ctx, 0, 0).
		Split()
...
func (mbbc PbMergeBuybackSystemTypeMapsBuilderClient) fetchBuilder(
	ctx context.Context,
	chnBuilderSend chanresult.ChanSendResult[cfg.BuybackSystemTypeMapsBuilder],
) error {
