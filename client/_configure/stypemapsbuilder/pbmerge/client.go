...
import (
	...
	builderget "github.com/WiggidyW/etco-go/client/configure/stypemapsbuilder/get"
...
func (msbc PbMergeShopLocationTypeMapsBuilderClient) Fetch(
	...
	chnBuilderSend, chnBuilderRecv := chanresult.
		NewChanResult[cfg.ShopLocationTypeMapsBuilder](ctx, 0, 0).
		Split()
...
func (msbc PbMergeShopLocationTypeMapsBuilderClient) fetchBuilder(
	ctx context.Context,
	chnBuilderSend chanresult.ChanSendResult[cfg.ShopLocationTypeMapsBuilder],
) error {
